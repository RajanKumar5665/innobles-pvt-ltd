 ...
 * (navy #172033, accent orange #F59E0B, soft slate #F8FAFC).
...
const Lucknow = () => (
  <Art label="Line-art illustration of the Rumi Darwaza gateway, Lucknow">
    <circle cx="250" cy="42" r="13" stroke="#F59E0B" />
    <path d="M126 142 V84 Q126 46 160 46 Q194 46 194 84 V142" stroke="#172033" strokeWidth="2.5" />
    <path d="M126 70 Q112 62 98 68 L92 142" stroke="#172033" />
    <path d="M194 70 Q208 62 222 68 L228 142" stroke="#172033" />
    <path d="M160 46 V28 M160 28 166 34 M160 28 154 34" stroke="#172033" strokeWidth="2.5" />
    <path d="M116 84 H126 M194 84 H204" stroke="#172033" />
    <path d="M142 142 V96 Q142 70 160 70 Q178 70 178 96 V142" stroke="#F59E0B" strokeWidth="1.75" />
    <path d="M84 142 H236" stroke="#172033" strokeWidth="2.5" />
  </Art>
);
...
const Mumbai = () => (
  <Art label="Line-art illustration of the Gateway of India and Mumbai skyline">
    ...
    <circle cx="64" cy="40" r="13" stroke="#F59E0B" />
    <g stroke="#172033" strokeWidth="2.5">
    ...
    <path d="M160 58 V48" stroke="#172033" strokeWidth="2" />
    <path d="M16 152 q8 -5 16 0 t16 0 t16 0 t16 0 t16 0 t16 0 t16 0 t16 0 t16 0 t16 0 t16 0" stroke="#F59E0B" strokeWidth="2" />
  </Art>
);
...
const Delhi = () => (
  <Art label="Line-art illustration of the India Gate, Delhi">
    ...
    <circle cx="252" cy="40" r="13" stroke="#F59E0B" />
    <g stroke="#172033" strokeWidth="2.5">
    ...
    <path d="M96 142 H224" stroke="#172033" strokeWidth="2.5" />
  </Art>
);
...
const UAE = () => (
  <Art label="Line-art illustration of the Dubai skyline and Burj Khalifa">
    <path d="M246 30 a12 12 0 1 0 4 20 a9 9 0 1 1 -4 -20" stroke="#F59E0B" strokeWidth="2" />
    <g stroke="#172033" strokeWidth="2">
    ...
    <path d="M24 142 H296" stroke="#172033" strokeWidth="2.5" />
  </Art>
);
