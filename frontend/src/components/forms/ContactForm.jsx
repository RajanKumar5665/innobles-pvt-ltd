    ...
    <form onSubmit={handleSubmit} noValidate className="grid gap-4 text-left">
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          {fieldError(errors, touched, "name") && (
            <p className="mt-1 text-xs text-red-400">{fieldError(errors, touched, "name")}</p>
          )}
        </div>
        <div>
          <input
          ...
          {fieldError(errors, touched, "email") && (
            <p className="mt-1 text-xs text-red-400">{fieldError(errors, touched, "email")}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          {fieldError(errors, touched, "phone") && (
            <p className="mt-1 text-xs text-red-400">{fieldError(errors, touched, "phone")}</p>
          )}
        </div>
        <div>
          <select
          ...
          {fieldError(errors, touched, "subject") && (
            <p className="mt-1 text-xs text-red-400">{fieldError(errors, touched, "subject")}</p>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        {fieldError(errors, touched, "message") ? (
          <p className="mt-1 text-xs text-red-400">{fieldError(errors, touched, "message")}</p>
        ) : (
